    ...
    <div className="bg-amber-300 p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white p-4 rounded-lg shadow-md">
          ...
          <img src="/burger.jpg" alt="Burger" width={350} height={200} className="rounded-lg mb-4" />
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          ...
          <img src="/friess.gif" alt="Fries" width={380} height={220} className="rounded-lg mb-4" />
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold
            ...
            <img src="/salad.jpg" alt="Salad" width={380} height={240} className="rounded-lg mb-4" />
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-2">Soda</h2>
            ...
            <img src="/soda.jpg" alt="Soda" width={380} height={270} className="rounded-lg mb-4" />
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-2">Dessert</h2>
            ...
            <img src="/desserts.jpg" alt="Dessert" width={330} height={290} className="rounded-lg mb-4" />
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          <h2 className="text-2xl font-semibold mb-2">Special Drink</h2>
            ...
            <img src="/special drink.jpg" alt="Special Drink" width={380} height={270} className="rounded-lg mb-4" />
